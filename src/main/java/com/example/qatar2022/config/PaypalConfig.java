...
public class PaypalConfig {
  ...
  // config to send the email, because we can put it also in the application.properties but i had an
  // error for the autowired, and than i decidet to put it here
  @Bean
